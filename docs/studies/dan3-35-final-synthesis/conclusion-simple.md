...
Preterism contributes a real and permanent insight: the Hellenistic historical layer in Daniel 8 and Daniel 11:21–35 is genuine, and no reading of Daniel should ignore it. But preterism cannot contain Daniel's own text, which extends unmistakably beyond the Maccabean era at every decisive point.
...
The most complete reading of Daniel is one that traces God's sovereignty through continuous history, acknowledges the Hellenistic fulfillment layer without confining the text to it, centers the narrative on Christ's redemptive work across three phases (first advent, heavenly ministry, return), and maintains the text's own insistence that the story ends with resurrection, judgment, and a kingdom that will stand forever.
