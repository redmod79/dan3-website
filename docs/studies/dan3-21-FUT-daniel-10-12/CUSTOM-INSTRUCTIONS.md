...
### FUT Prompt Review (port 9883)

Launch a subagent that:
1. Reads `D:/bible/tools/fut-position/DB-SUMMARY.md` to understand what the FUT position argues for this chapter
2. Reads `D:\Bible\bible-studies\dan3-21-FUT-daniel-10-12/PROMPT.md`
3. Searches the FUT position DB (port 9883) for arguments relevant to this study's chapter:
   ```bash
   cd "D:\bible\tools\fut-position\search" && python search_client.py "QUERY" --top 20
   ```
4. For each FUT argument NOT already covered by PROMPT.md's verse lists, focus areas, or research directives:
...
2. Reads `D:\Bible\bible-studies\dan3-21-FUT-daniel-10-12/CONCLUSION.md` and `D:\Bible\bible-studies\dan3-21-FUT-daniel-10-12/03-analysis.md`
...
6. Writes `D:\Bible\bible-studies\dan3-21-FUT-daniel-10-12/fut-validation.md` with findings
...
Each validator writes `D:\Bible\bible-studies\dan3-21-FUT-daniel-10-12/{position}-revalidation.md`.
...
```
### [dan3-21-FUT-daniel-10-12] {POSITION} — [brief description]
- **Study:** dan3-21-FUT-daniel-10-12
- **Position:** {POSITION}
- **Layer:** [1 or 2]
