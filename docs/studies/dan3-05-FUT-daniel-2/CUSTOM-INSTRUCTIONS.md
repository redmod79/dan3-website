...
2. Reads `D:\Bible\bible-studies\dan3-05-FUT-daniel-2/PROMPT.md`
...
2. Reads `D:\Bible\bible-studies\dan3-05-FUT-daniel-2/CONCLUSION.md` and `D:\Bible\bible-studies\dan3-05-FUT-daniel-2/03-analysis.md`
...
6. Writes `D:\Bible\bible-studies\dan3-05-FUT-daniel-2/fut-validation.md` with findings
...
Each validator writes `D:\Bible\bible-studies\dan3-05-FUT-daniel-2/{position}-revalidation.md`.
...
```
### [dan3-05-FUT-daniel-2] {POSITION} — [brief description]
