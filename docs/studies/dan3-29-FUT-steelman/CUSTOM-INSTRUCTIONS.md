...
2. Reads `D:\Bible\bible-studies\dan3-29-FUT-steelman/PROMPT.md`
...
2. Reads `D:\Bible\bible-studies\dan3-29-FUT-steelman/CONCLUSION.md` and `D:\Bible\bible-studies\dan3-29-FUT-steelman/03-analysis.md`
...
6. Writes `D:\Bible\bible-studies\dan3-29-FUT-steelman/fut-validation.md` with findings
...
Each validator writes `D:\Bible\bible-studies\dan3-29-FUT-steelman/{position}-revalidation.md`.
...
```
### [dan3-29-FUT-steelman] {POSITION} — [brief description]
- **Study:** dan3-29-FUT-steelman
- **Position:** {POSITION}
- **Layer:** [1 or 2]
