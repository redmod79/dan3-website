...
### PRET Prompt Review (port 9884)

Launch a subagent that:
1. Reads `D:/bible/tools/pret-position/DB-SUMMARY.md` to understand what the PRET position argues for this chapter
2. Reads `D:\Bible\bible-studies\dan3-20-PRET-daniel-10-12/PROMPT.md`
3. Searches the PRET position DB (port 9884) for arguments relevant to this study's chapter:
   ```bash
   cd "D:\bible\tools\pret-position\search" && python search_client.py "QUERY" --top 20
   ```
4. For each PRET argument NOT already covered by PROMPT.md's verse lists, focus areas, or research directives:
...
2. Reads `D:\Bible\bible-studies\dan3-20-PRET-daniel-10-12/CONCLUSION.md` and `D:\Bible\bible-studies\dan3-20-PRET-daniel-10-12/03-analysis.md`
...
6. Writes `D:\Bible\bible-studies\dan3-20-PRET-daniel-10-12/pret-validation.md` with findings
...
Each validator writes `D:\Bible\bible-studies\dan3-20-PRET-daniel-10-12/{position}-revalidation.md`.
...
```
### [dan3-20-PRET-daniel-10-12] {POSITION} — [brief description]
- **Study:** dan3-20-PRET-daniel-10-12
- **Position:** {POSITION}
- **Layer:** [1 or 2]
