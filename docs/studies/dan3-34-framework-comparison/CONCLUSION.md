...
**PRET contributes:**
1. Antiochus IV matches *some* specifications in Dan 8 and Dan 11:21-35 — directional growth, tamid removal, sanctuary desecration, host-by-transgression, and the Dan 11:21-35 Ptolemaic-Seleucid historical sequence. These partial matches are textually real. However, calling Antiochus a "genuine referent" overstates the case: he fails the gadal/yether scale requirement (near-N against — his territory ~3M km2 was smaller than both Medo-Persia ~5.5-8M and Greece ~5.2M km2), faces 6 I-B resolutions against PRET (everlasting kingdom, gadal/yether, Dan 8-9 disconnection, AD 70 exhaustion, beast-slain, 490-year arithmetic), and fails five specifications in Dan 11:40-45 (including dying in the wrong location — Persia, not "between the seas"). The Antiochus identification works for a subset of specifications while failing the constraints that distinguish partial from complete fulfillment.
2. The be-acharit malkutam timestamp (Dan 8:23) grammatically anchors the horn's rise within the Greek successor era. This is PRET's strongest text-derived datum. Non-PRET positions must explain how the horn both arises in the Greek era and extends beyond it.
