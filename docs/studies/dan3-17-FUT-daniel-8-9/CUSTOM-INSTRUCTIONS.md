...
2. Reads `D:\Bible\bible-studies\dan3-17-FUT-daniel-8-9/PROMPT.md`
...
2. Reads `D:\Bible\bible-studies\dan3-17-FUT-daniel-8-9/CONCLUSION.md` and `D:\Bible\bible-studies\dan3-17-FUT-daniel-8-9/03-analysis.md`
...
6. Writes `D:\Bible\bible-studies\dan3-17-FUT-daniel-8-9/fut-validation.md` with findings
...
Each validator writes `D:\Bible\bible-studies\dan3-17-FUT-daniel-8-9/{position}-revalidation.md`.
...
```
### [dan3-17-FUT-daniel-8-9] {POSITION} — [brief description]
- **Study:** dan3-17-FUT-daniel-8-9
- **Position:** {POSITION}
- **Layer:** [1 or 2]
