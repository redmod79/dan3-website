...
2. Reads `D:\Bible\bible-studies\dan3-06-COMPARE-daniel-2/CONCLUSION.md` and `D:\Bible\bible-studies\dan3-06-COMPARE-daniel-2/03-analysis.md`
...
6. Writes `D:\Bible\bible-studies\dan3-06-COMPARE-daniel-2/hist-validation.md` with findings
...
4. Check whether the PRET position is **accurately represented** in the comparison:
   ...
   - Are there arguments the perspective study covered that the COMPARE study ignored?
6. Writes `D:\Bible\bible-studies\dan3-06-COMPARE-daniel-2/pret-validation.md` with findings
   - Include a summary line: `LAYER 1 ISSUES: X` (count of representation problems)
   - Include a summary line: `LAYER 2 ISSUES: Y` (count of grounding problems)
   - For each issue, specify the exact section, the nature of the problem, and what needs to change
...
4. Check whether the FUT position is **accurately represented** in the comparison:
   ...
   - Are there arguments the perspective study covered that the COMPARE study ignored?
6. Writes `D:\Bible\bible-studies\dan3-06-COMPARE-daniel-2/fut-validation.md` with findings
   - Include a summary line: `LAYER 1 ISSUES: X` (count of representation problems)
   - Include a summary line: `LAYER 2 ISSUES: Y` (count of grounding problems)
   - For each issue, specify the exact section, the nature of the problem, and what needs to change
...
Each validator writes `D:\Bible\bible-studies\dan3-06-COMPARE-daniel-2/{position}-revalidation.md`.
...
```
### [dan3-06-COMPARE-daniel-2] {POSITION} — [brief description]
- **Study:** dan3-06-COMPARE-daniel-2
- **Position:** {POSITION}
