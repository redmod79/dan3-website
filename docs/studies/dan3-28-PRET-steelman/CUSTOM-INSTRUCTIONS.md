...
2. Reads `D:\Bible\bible-studies\dan3-28-PRET-steelman/PROMPT.md`
...
2. Reads `D:\Bible\bible-studies\dan3-28-PRET-steelman/CONCLUSION.md` and `D:\Bible\bible-studies\dan3-28-PRET-steelman/03-analysis.md`
...
6. Writes `D:\Bible\bible-studies\dan3-28-PRET-steelman/pret-validation.md` with findings
...
Each validator writes `D:\Bible\bible-studies\dan3-28-PRET-steelman/{position}-revalidation.md`.
...
```
### [dan3-28-PRET-steelman] {POSITION} — [brief description]
- **Study:** dan3-28-PRET-steelman
- **Position:** {POSITION}
- **Layer:** [1 or 2]
