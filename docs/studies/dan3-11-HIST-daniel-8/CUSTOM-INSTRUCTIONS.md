...
2. Reads `D:\Bible\bible-studies\dan3-11-HIST-daniel-8/PROMPT.md`
...
2. Reads `D:\Bible\bible-studies\dan3-11-HIST-daniel-8/CONCLUSION.md` and `D:\Bible\bible-studies\dan3-11-HIST-daniel-8/03-analysis.md`
...
6. Writes `D:\Bible\bible-studies\dan3-11-HIST-daniel-8/hist-validation.md` with findings
...
Each validator writes `D:\Bible\bible-studies\dan3-11-HIST-daniel-8/{position}-revalidation.md`.
...
```
### [dan3-11-HIST-daniel-8] {POSITION} — [brief description]
- **Study:** dan3-11-HIST-daniel-8
- **Position:** {POSITION}
- **Layer:** [1 or 2]
