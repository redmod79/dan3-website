...
2. Reads `D:\Bible\bible-studies\dan3-27-HIST-steelman/PROMPT.md`
...
2. Reads `D:\Bible\bible-studies\dan3-27-HIST-steelman/CONCLUSION.md` and `D:\Bible\bible-studies\dan3-27-HIST-steelman/03-analysis.md`
...
6. Writes `D:\Bible\bible-studies\dan3-27-HIST-steelman/hist-validation.md` with findings
...
Each validator writes `D:\Bible\bible-studies\dan3-27-HIST-steelman/{position}-revalidation.md`.
...
```
### [dan3-27-HIST-steelman] {POSITION} — [brief description]
- **Study:** dan3-27-HIST-steelman
- **Position:** {POSITION}
- **Layer:** [1 or 2]
